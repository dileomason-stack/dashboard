...
- Deployed on Vercel from a GitHub repo, so every push redeploys. Live at https://thehomeroom.vercel.app (the app is named Homeroom; the old https://onlyonescreen.vercel.app redirects here)
